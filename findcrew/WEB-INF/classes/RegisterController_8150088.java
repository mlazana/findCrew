...
*/
public class RegisterController_8150088 extends HttpServlet {
	...
	try {
		...
		out.println("");
		out.println("		<title>1st Lab Exercise</title>");
		out.println("");
		...
		out.println("					</button>");
		out.println("					<a class='navbar-brand' href='../index_8150088.html'>8150088</a>");
		out.println("				</div>");
		out.println("				<div id='navbar' class='navbar-collapse collapse'>");
		out.println("					<ul class='nav navbar-nav'>");
		out.println("						<li class='active'><a href='../index_8150088.html'>Home</a></li>");
		out.println("						<li><a href='../register_8150088.html'>Register</a></li>");
		out.println("						<li><a href='../about_8150088.html'>About</a></li>");
		out.println("					</ul>");
		out.println("");
		out.println("				</div>");
		...
		if (registrationAgreeTerms == null){
			...
			out.println("		</div>");
		} else if ((registrationName.length()>=3) & (registrationSurname.length()>=3) & (registrationUsername.length()>=5) & (registrationPassword.length()>=5) & (registrationPassword.equals(registrationConfirm))) {
			out.println("		<div class='page-header'>");
			...
			out.println("			<a class='btn btn-info' href='http://ism.dmst.aueb.gr/ismgroup20/register_8150088.html' role='button'> <b><</b> Back to the form</a>");
			out.println("		</div>");
		}
  ...
  // Method to handle GET method request.
     public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.sendRedirect("http://ism.dmst.aueb.gr/ismgroup20/register_8150088.html");

		  ...
		  <div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
			  <ul class="navbar-nav ml-auto">
				...
				<%if (userdao.getShipownerId(iduser)!= -1) {%>
					<li class="nav-item dropdown"> 
				...
				<% } else if (userdao.getAdminId(iduser) != null) { %>
					<li class="nav-item dropdown"> 
						<a class="nav-link dropdown-toggle" id="navbarDropdownPortfolio" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"><i><b><%=user.getUsername()%></b></i></a>
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
							<a href="admin_main.jsp" class="dropdown-item">Administration</a>
						</div>
					</li>
				<%}else { %>
					<li class="nav-item">
						<a class="nav-link js-scroll-trigger"><i><b><%=user.getUsername()%></b></i></a>
					</li>
				<% } %>
				<%
					}

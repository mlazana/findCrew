...
<html lang="en">
 ...
 <body>
	    ...
	    <div class="container">
	    	<div class="row">
		        ...
		        <div class=" col-lg-8 col-md-8  ">
		            ...
		            <a href="contact_request.jsp?crew_id=<%= id %>" class="btn btn-primary btn-lg"> Contact <%=individual.getName() %></a>
                    <a href="favorites.jsp?crew_id=<%= id %>" class="btn btn-primary btn-lg" > Add to favourites</a>
	   ...
	   <% request.setAttribute("id_crew",individual.getIdcrew());  %>
	    ...
	    <!-- footer -->
		<footer class="py-3 bg-dark foot">

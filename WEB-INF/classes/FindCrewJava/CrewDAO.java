...
public class CrewDAO {
	...
	public List<Crew> getCrewsByGend(String gender) throws Exception {

		Connection con = null;

		// Define the SQL statement (to be executed)
		String sql = "SELECT * FROM crew WHERE gender=?;";
	...
	} //End of getCrewsByGend
	
	public List<Crew> getCrewsByProfGend(String profession, String gender) throws Exception {

		Connection con = null;

		// Define the SQL statement (to be executed)
		String sql = "SELECT * FROM crew WHERE profession=? AND gender=?;";
	...
	} //End of getCrewsByProfGend
	
	public List<Crew> getCrewsByCounGend(String country, String gender) throws Exception {

		Connection con = null;

		// Define the SQL statement (to be executed)
		String sql = "SELECT * FROM crew WHERE country=? AND gender=?;";

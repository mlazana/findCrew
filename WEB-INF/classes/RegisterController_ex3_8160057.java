...
import exercise3_2018_2019_8160057.*;

public class RegisterController_ex3_8160057 extends HttpServlet {
     public void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         User usr_m = new User( name,  surname,  email,  username,  password);

         User usr = udao.findUser(username);
			...
			out.println("       </div>	");
              ...
              (password.length() >=5) && (password.equals(confirm))&& (usr == null) ) {


               udao.registerUser(usr_m);
			  ...
			  if (usr != null ){out.println ("<p>" + s + ". username: " + usr.getName() +  " already exists</p>"); }
			...
			/* Footer */
			out.println("</div>");
			RequestDispatcher rd=request.getRequestDispatcher("../footer_ex3_8160057.jsp");
     ...
     public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
	     	...
	     	try {
				...
				out.println("</html>");
	             ...
	             out.println("Exception: " + ex.getMessage() + "fghdfghdfghdf");
	             out.println("</body>");
	             out.println("</html>");
	           }

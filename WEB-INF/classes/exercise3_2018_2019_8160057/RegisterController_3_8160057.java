...
public class RegisterController_3_8160057 extends HttpServlet {
     public void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
             ...
             User findUsr = udao.findUser(username);
			...
			out.println("       </div>	");
              ...
              (password.length() >=5) && (password.equals(confirm)) && (findUsr == null) ) {
			  ...
			  if (findUsr != null ){out.println ("<p>" + s + ". username" + findUsr +  " already exists</p>"); }


			   out.println(s + ". username " + findUsr.getUsername() + "already exists");
     ...
     public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
	     	...
	     	try {
				...
				out.println("			<div class='jumbotron'>");
				out.println("				<h1>1 atomiki askisi</h1>");
				out.println("			</div>");

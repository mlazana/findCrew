	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
		...
		try {
			...
			if (checkbox == null) {
				...
				out.println("<h1>Registration done! Enjoy the FindCrew experience.</h1>");
				out.println("<div class='alert alert-success' role='alert'>");
				out.println("  <strong>Note:</strong> Now you can login with the credentials that you entered");
				out.println("</div>");

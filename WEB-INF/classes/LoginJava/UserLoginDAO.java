...
public class UserLoginDAO {
	...
	*/
    ...
    public int getShipownerId(int iduser) throws Exception {

		Connection con = null;

		String sql = "SELECT idshipowner FROM shipowner WHERE userid = ? ;";
	    ...
	    try{
			...
			if (rs.next()) {
			 ...
			 int shipownerId = rs.getInt("idshipowner") ;
    ...
    public String getAdminId(int iduser) throws Exception {

		Connection con = null;

		String sql = "SELECT adminid FROM admin WHERE userid_admin = ? ;";
	    ...
	    try{
			...
			if (rs.next()) {
				...
				String idadmin = rs.getString("adminid") ;
